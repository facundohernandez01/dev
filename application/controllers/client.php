...
switch ($action) {
    case 'iview':
        ...
        if ($d) {
            ...
            $vtoken = $d['vtoken'];
            if ($token != $vtoken) {
                echo 'Sorry Token does not match!ssssss';
                exit();
            }
    ...
    case 'q':
        ...
        if ($d) {
            ...
            $vtoken = $d['vtoken'];
            if ($token != $vtoken) {
                echo 'Sorry Token does not match!33';
                exit();
            }
    ...
    case 'iprint':
        ...
        if ($d) {
            ...
            $vtoken = $d['vtoken'];
            if ($token != $vtoken) {
                echo 'Sorry Token does not match!444';
                exit();
            }
    ...
    case 'iprint2':
        ...
        case 'iprint3':
            ...
            if ($d) {
                ...
                $vtoken = $d['vtoken'];
                if ($token != $vtoken) {
                    echo 'Sorry Token does not match for Remitos';
                    exit();
                }
	...
	case 'ipdfrec':
        Event::trigger('client/ipdfrec/');

        $id = $routes['2'];
        $token = $routes['3'];

        Recibo::pdf($id, 'inline', $token);

        break;

        case 'ipdfrem':
            Event::trigger('client/ipdfrem/');
    
            $id = $routes['2'];
            $token = $routes['3'];
    
            Remito::pdf($id, 'inline', $token);
    ...
    case 'ipay':
        ...
        if ($d) {
            ...
            $vtoken = $d['vtoken'];
            if ($token != $vtoken) {
                echo 'Sorry Token does not matchwww!';
                exit();
            }
  ...
  <input type="submit" value="Pay ' .
    ...
    case 'ipay_ipn':
        ...
        if ($d) {
            ...
            $ptoken = $d['ptoken'];
            if ($token != $ptoken) {
                echo 'Sorry Token does not match!123123';
                exit();
            }
    ...
    case 'ipay_success':
        ...
        if ($d) {
            ...
            $vtoken = $d->vtoken;
            if ($token != $ptoken) {
                echo 'Sorry Token does not match!234234';
                exit();
            }
        ...
        if ($p) {
            ...
            if ($nonce) {
                ...
                if ($d) {
                    ...
                    $vtoken = $d['vtoken'];
                    if ($token != $vtoken) {
                        echo 'Sorry Token does not match!678';
                        exit();
                    } else {
                        // echo 'TOKEN MATCHES!!!!!!!!!!!!!!!!';
                        $i_credit = $d['credit'];
    ...
    case 'q_accept':
        ...
        if ($d) {
            ...
            $vtoken = $d['vtoken'];
            if ($token != $vtoken) {
                echo 'Sorry Token does not match11111111111222!';
                exit();
            }
    ...
    case 'q_decline':
        ...
        if ($d) {
            ...
            $vtoken = $d['vtoken'];
            if ($token != $vtoken) {
                echo 'Sorry Token does not match!23232323';
                exit();
            }
