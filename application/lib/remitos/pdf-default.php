<style>
    ...
    * { margin: 0; padding: 0; }
    ...
    #logo { text-align: right; float: right; position: relative; margin-top: 2z5px; border: 1px solid #fff; max-width: 540px; overflow: hidden; }
    ...
    <table width="100%">
        <tr>
            <td style="border: 0;  text-align: left" width="62%">
                <span style="font-size: 18px; color: #2f4f4f"><strong>Recibo # <?php echo $d['id']; ?></strong></span>
            </td>
    ...
    <div id="customer">
        ...
        <table id="meta">
            ...
            <tr>
                ...
                <td class="meta-head">Recibo Date</td>
    ...
    <table id="items" <?php if(($d['status']) == 'Paid'){ echo 'background="'.APP_URL.'/application/lib/invoices/images/paid.png" style="background-repeat:no-repeat;"'; } ?> >
        ...
        if (($d['tax']) != '0.00'){
            ...
            <tr>
                ...
                <td class="blank"> </td>
                <td colspan="2" class="total-line">IMP</td>
