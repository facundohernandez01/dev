...
*/
        ...
        * { margin: 0; padding: 0; }
        ...
        #page-wrap { width: 800px; margin: 0 auto; 
            background-image: url('http://192.168.1.10:80/gestion/application/storage/system/BGREMITO.png');
        }
...
<div id="page-wrap">
    ...
    <table width="100%">
        <tr style="border: 0;">
            <td style="border: 0;  text-align: left" width="42%"><div id="logo" style="font-size:18px">
				...
				<?php echo $config['caddress']; ?>
				            ...
				            <td style="border: 0;  text-align: left" width="38%">
                <span style="font-size: 32px;"><strong><?php echo $_L['Remito']; ?>
				</strong></span><p>			
				...
				<?php
						...
						Fecha: <?php echo date($config['df'], strtotime($d['date'])); ?><br><br>
...
<hr>
    ...
    <div id="customer">
        ...
        <table id="meta">
            <tr>
                <td rowspan="0" style="border: 1px solid white; border-right: 1px solid white; text-align: left" width="50%">
                    <?php if($a['company'] != '') {
                        ?>
                    <strong>Cliente: </strong> <?php echo $a['company']; ?> <strong> - <?php echo $_L['ATTN']; ?>: </strong> <?php echo $a['account']; ?> <br>
                    <?php
                    }
                    else{
                        ?>
                    ...
                    ?>
                    <strong>Dirección: </strong><?php echo $a['address']; ?><br>
                    <strong>Ciudad: </strong><?php echo $a['city']; ?><br>
                    <strong>Prov: </strong><?php echo $a['state']; ?><br> 
                    <strong>CP: </strong><?php echo $a['zip']; ?><br>
                    <?php
                    if(($a['phone']) != ''){
                        echo '<strong>Tel: </strong>'. $a['phone']. ' <br>';
                    }
                    if(($a['email']) != ''){
                        echo '<strong>Email: </strong>'. $a['email']. ' <br>';
                    }
                    foreach ($cf as $cfs){
                        echo '<strong>'.$cfs['fieldname'].':</strong> '. get_custom_field_value($cfs['id'],$a['id']). ' <br>';
                    }
                    ?>                
                ...
                <strong> Datos transporte: </strong><br>
                    <?php foreach ($trsp as $trspte){
                        echo '<strong>Transporte: </strong>'.$trspte['nombre_transporte'].'<br>';
                        echo '<strong>Tel: </strong>'.$trspte['telefono_transporte'].'<br>';
                        echo '<strong>Dirección: </strong>'.$trspte['direccion_transporte'].'<br>';
                        echo '<strong>Horarios: </strong>'.$trspte['horario_transporte'].'<br>';
                        } ?><br><br><br><br>
                </td>
