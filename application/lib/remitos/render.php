...
<head>
    ...
    <title><?php echo $_L['RECIBO']; ?> <?php echo $d['id']; ?></title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; }
        ...
        #page-wrap { width: 800px; margin: 0 auto; 
            background-image: url('http://localhost/gestion/application/storage/system/BGRECIBO.png');
        }
    ...
    <table width="100%">
        <tr>
            <td style="border: 0;  text-align: left" width="62%">
                ...
                <br><br>
                <span style="font-size: 18px; color: #2f4f4f"><strong><?php echo $_L['RECIBO']; ?> # <?php
                        if($d['cn'] != ''){
                            $dispid = $d['cn'];
                        }
                        else{
        ...
        <table id="meta">
            <tr>
                <td rowspan="5" style="border: 1px solid white; border-right: 1px solid black; text-align: left" width="62%">
                    ...
                    ?></td>
                <td class="meta-head"><?php echo $_L['RECIBO']; ?> #</td>
