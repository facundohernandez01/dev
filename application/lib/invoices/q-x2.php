 ...
 ?></strong></span>
    ...
    'account'
     ...
     'state'
            ...
            <tr>
            <td class="meta-head">Condición de pago</td>
                <td><?php echo $d['cond_pago']?> días</td>
            </tr>
    ...
    <table id="items">
        ...
        <tr>
            ...
            <th width="7%" align="right">Ctd</th>
            <th width="7%" align="right">U.M</th>
        ...
        <?php foreach ($items as $item) {
            ...
            <td class="description">' .
                ...
                '</td>
            <td align="right">' .
                ib_money_format($item['amount'], $config, $d['currency_symbol']) .
                '</td>
            <td align="right">' .
                $item['qty'] .
                '</td>
...
<?php } }?>
        ...
        <td style="border: 0;"></td>
        <td style="border: 0;"></td>
            <td colspan="1" class="total-line"><?php echo $_L[
                'Sub Total'
            ]; ?></td>
        ...
        <?php if ($d['tax1'] != '0.00' and $d['tax1'] != '') { ?>
            ...
            <td style="border: 0;"></td>
            <td style="border: 0;"></td>
                <td colspan="1" class="total-line"><?php echo $d[
                    'taxname'
                ]; ?></td>
        ...
        <?php } ?>
            ...
            <td style="border: 0;"></td>
            <td style="border: 0;"></td>
                <td colspan="1" class="total-line balance"><?php echo $_L[
                    'Grand Total'
                ]; ?></td>
