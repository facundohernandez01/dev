    ...
    <table width="100%">
        <tr>
            <td style="border: 0;  text-align: left" width="62%">
                <span style="font-size: 28px; color: #2f4f4f"><strong><?php echo $_L['INVOICE']; ?> # <?php
                        if($d['cn'] != ''){
                            $dispid = $d['cn'];
                        }
                        else{
                        ...
                        ?></strong></span><br>
                        Fecha <?php echo date($config['df'], strtotime($d['date'])); ?>
            </td>               
...
<hr>
    ...
    <div id="customer">
        ...
        <table id="meta">
            <tr>
                <td rowspan="5" style="border: 1px solid white; border-right: 1px solid white; text-align: left" width="62%"> <strong><?php echo $_L['Invoiced To']; ?></strong> <br>
                    <?php if($a['company'] != '') {
                        ?>
    ...
    <table id="items">
        ...
        <tr>
            ...
            <th width="20%" align="right"><?php echo $_L['Price']; ?></th>
            <th width="8%" align="right">Cant</th>
