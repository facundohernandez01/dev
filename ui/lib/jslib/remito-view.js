$(document).ready(function () {
    ...
    //
    //    $.get( _url + "recibos/pdf/"+iid+"/store/", function() {
    //
    //    });
    //
    //}
    ...
    sysrender.on('click', '#add_payment', function(e){
        ...
        $modal.load( _url + 'recibos/add-payment/' + iid, '', function(){
            $modal.modal();
    ...
    sysrender.on('click', '#mail_invoice_created', function(e){
        ...
        $modal.load( _url + 'recibos/mail_invoice_/' + iid + '/created', '', function(){
            $modal.modal();
            $('.sysedit').summernote({
    ...
    sysrender.on('click', '#mail_invoice_reminder', function(e){
        ...
        $modal.load( _url + 'recibos/mail_invoice_/' + iid + '/reminder', '', function(){
            $modal.modal();
            $('.sysedit').summernote({
    ...
    sysrender.on('click', '#mail_invoice_overdue', function(e){
        ...
        $modal.load( _url + 'recibos/mail_invoice_/' + iid + '/overdue', '', function(){
            $modal.modal();
            $('.sysedit').summernote({
    ...
    sysrender.on('click', '#mail_invoice_confirm', function(e){
        ...
        $modal.load( _url + 'recibos/mail_invoice_/' + iid + '/confirm', '', function(){
            $modal.modal();
            $('.sysedit').summernote({
    ...
    sysrender.on('click', '#mail_invoice_refund', function(e){
        ...
        $('body').modalmanager('loading');
        $modal.load( _url + 'recibos/mail_invoice_/' + iid + '/refund', '', function(){
            $modal.modal();
            $('.sysedit').summernote({
    ...
    $modal.on('click', '#save_payment', function(){
        ...
        var _url = $("#_url").val();
        $.post(_url + 'recibos/add-payment-post', {
    ...
    $("#mark_paid").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                var iid = $("#iid").val();
                $.post(  _url + "recibos/markpaid", { iid: iid })
                    .done(function( data ) {
                        location.reload();
                    });
            }
    ...
    $("#mark_unpaid").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
           if(result){
               var iid = $("#iid").val();
               $.post(  _url + "recibos/markunpaid", { iid: iid })
                   .done(function( data ) {
                       location.reload();
                   });
           }
    ...
    $("#mark_cancelled").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                var iid = $("#iid").val();
                $.post(  _url + "recibos/markcancelled", { iid: iid })
                    .done(function( data ) {
                        location.reload();
                    });
            }
    ...
    $("#mark_partially_paid").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                var iid = $("#iid").val();
                $.post(  _url + "recibos/markpartiallypaid", { iid: iid })
                    .done(function( data ) {
                        location.reload();
                    });
            }
