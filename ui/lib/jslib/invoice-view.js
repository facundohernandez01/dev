$(document).ready(function () {
    ...
    $("#convert_arecibo").click(function (e) {
        e.preventDefault();
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                ...
                var iid = $("#iid").val();
                $.post(  _url + "invoices/convert_arecibo/", { iid: iid })
                    .done(function( data ) {
                       // console.log(data);
                        $('#ibox').unblock();
    ...
    $("#convert_arecibo_parcial").click(function (e) {
        e.preventDefault();
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                $('#ibox').block({ message: null });
                var iid = $("#iid").val();
                $.post(  _url + "invoices/convert_arecibo_parcial/", { iid: iid })
                    .done(function( data ) {
                       // console.log(data);
                        $('#ibox').unblock();
    ...
    $("#convert_aremito").click(function (e) {
        e.preventDefault();
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                $('#ibox').block({ message: null });
                var iid = $("#iid").val();
                $.post(  _url + "invoices/convert_aremito/", { iid: iid })
                    .done(function( data ) {
                       // console.log(data);
                        $('#ibox').unblock();
    ...
    $("#convert_aremito_parcial").click(function (e) {
        e.preventDefault();
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                $('#ibox').block({ message: null });
                var iid = $("#iid").val();
                $.post(  _url + "invoices/convert_aremito_parcial/", { iid: iid })
                    .done(function( data ) {
                       // console.log(data);
                        $('#ibox').unblock();
