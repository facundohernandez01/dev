...
<div class="modal-body">
    ...
    <form class="form-horizontal" id="rform">
        ...
        <div class="form-group" ><label class="col-lg-2 control-label" for="company">ID Cliente</label>
            <div class="col-lg-10" >
            <input type="text" id="company3" name="company3" class="form-control"  disabled>
            <input type="text" id="company2" name="company2" class="form-control"  disabled>
