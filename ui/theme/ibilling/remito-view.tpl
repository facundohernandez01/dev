    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <label for="exampleInputEmail1">{$_L['Unique Remito URL']}:</label>
                <input type="text" class="form-control" id="remito_public_url" onClick="this.setSelectionRange(0, this.value.length)" value="{$_url}client/iview/{$d['id']}/token_{$d['vtoken']}">
            </div>
        </div>
        <div class="col-lg-12"  id="application_ajaxrender">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>{$_L['REMITO']} N° {$d['invoicenum']}{if $d['cn'] neq ''}{$d['cn']}{else}{$d['id']}{/if} </h5>
                    <input type="hidden" name="iid" value="{$d['id']}" id="iid">


                    <div class="btn-group  pull-right" role="group" aria-label="...">
                    <a href="#" class="btn btn-success btn-sm" id="mail_invoice_created"><i class="fa fa-envelope-o"></i> {$_L['Send']}</a>
        ...
        {*<div class="btn-group" role="group">
                        ...
                        <a href="{$_url}remitos/edit/{$d['id']}" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> {$_L['Edit']}</a>
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{$_url}client/ipdfrem/{$d['id']}/token_{$d['vtoken']}/view/" target="_blank">{$_L['View PDF']}</a></li>
                                <li><a href="{$_url}client/ipdfrem/{$d['id']}/token_{$d['vtoken']}/dl/">{$_L['Download PDF']}</a></li>
                            </ul>
                    ...
                    <div class="remito">
                        <header class="clearfix">
                            <div class="row">
                                <div class="col-sm-6 mt-md">
                                    <h2 class="h2 mt-none mb-sm text-dark text-bold">{$_L['Remito']} N° {$d['invoicenum']}{if $d['cn'] neq ''}{$d['cn']}{else}{$d['id']}{/if}</h2>
                                        <div class="bill-to">
                        ...
                        <div class="bill-info">
                            <div class="row">
                                ...
                                {foreach $trsp as $tr}
                                    <tr>
                                    <td><strong>Transporte: </strong> {$tr['nombre_transporte']}</td><br>
                                    <td><strong>Tel: </strong> {$tr['telefono_transporte']}</td><br>
                                    <td><strong>Dirección: </strong> {$tr['direccion_transporte']}</td><br>
                                    </tr>
                                 {/foreach}
                                </div>
                                <div class="col-md-6">
