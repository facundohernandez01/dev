<ul class="nav" id="side-menu" >
    ...
    {if has_access($user->roleid,'reports')}
        <li {if $_application_menu eq 'dashboard'}class="active"{/if}><a href="{$_url}{$_c['redirect_url']}/"><i class="fa fa-home"></i> <span class="nav-label">{$_L['Dashboard']}</span></a></li>
    {/if}
    ...
    {if has_access($user->roleid,'sales')}
        ...
        {if ($_c['invoicing'] eq '1') OR ($_c['quotes'] eq '1')}
            ...
            <li class="{if $_application_menu eq 'invoices'}active{/if}">
                ...
                <ul class="nav nav-second-level">
                    ...
                    {if $_c['invoicing'] eq '1'}
                        ...
                        <li><a href="{$_url}recibos/add/">{$_L['New recibo']}</a></li>
                        <li><a href="{$_url}recibos/list/">{$_L['Listar recibos']}</a></li>
         ...
         <li class="{if $_application_menu eq 'transportes'}active{/if}">
            <a href="{$_url}transportes/t-list/"><i class="fa fa-truck"></i> <span class="nav-label">{$_L['Transportes']}</span><span class="fa arrow"></span></a>
            </li>
    ...
    {if ($_c['invoicing'] eq '1') OR ($_c['quotes'] eq '1')}
        <li class="{if $_application_menu eq 'ps'}active{/if}">
            ...
            <ul class="nav nav-second-level">
                ...
                <li><a href="{$_url}ps/add/">{$_L['New Product']}</a></li>
