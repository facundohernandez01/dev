        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="row border-bottom">
                <nav class="navbar navbar-fixed-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    <li><a class="btn" href="{$_url}quotes/list/">{$_L['Quotes']}</a></li>
                    <li><a class="btn" href="{$_url}quotes/new/">{$_L['Create New Quote']}</a></li>
                        ...
                        <li class="dropdown navbar-user">
                            ...
                            <ul class="dropdown-menu animated fadeIn">
                                ...
                                <li class="divider"></li>
								<li><a href="/?ng=util/dbbackup/" class="btn btn-primary btn-xs"><i class="fa fa-download"></i>{$_L['Change Password']}</a></li>
								<li class="divider"></li>
