          ...
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <form class="form-horizontal" role="form" id="edit_form" method="post">
              <div class="form-group">
                ...
                <div class="col-sm-10">
               <tr> <td> <input type="text" class="form-control" value="{$d['name']}" name="name" id="name">  </td>
                </div>
              </div>
              <div class="form-group">
              ...
              <input type="text" class="form-control" name="c1" value="{$d['c1']}" id="c1"></div>
              </div>
              <div class="form-group">
              <label for="c2" class="col-sm-2 control-label">Material de Construcción</label><div class="col-sm-10">
              <input type="text" class="form-control" name="c2" value="{$d['c2']}" id="c2"></div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                 <td><textarea id="description" name="description" class="form-control" rows="3">{$d['description']}</textarea></td></tr>
                </div>
              </div>
            </form>
            ...
            <div class="modal-footer">
                ...
                <button id="update_item" class="btn btn-primary">{$_L['Update']}</button>
            </div>