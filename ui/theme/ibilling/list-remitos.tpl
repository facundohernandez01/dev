            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        {if $view_type neq 'filter'}
                            <a href="{$_url}remitos/list/filter/" class="btn btn-primary btn-xs"><i class="fa fa-search"></i> {$_L['Filter']}</a>
                        {else}
                            <a href="{$_url}remitos/list/" class="btn btn-primary btn-xs"><i class="fa fa-arrow-left"></i> {$_L['Back']}</a>
                        {/if}
                        <a href="{$_url}remitos/add/" class="btn btn-primary btn"><i class="fa fa-plus"></i> Generar Remito</a>
                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-bordered table-hover sys_table footable" {if $view_type == 'filter'} data-filter="#foo_filter" data-page-size="50" {/if}>
                        ...
                        {foreach $d as $ds}
                            <tr>
                                <td  data-value="{$ds['id']}"><a href="{$_url}remitos/view/{$ds['id']}/">{$ds['invoicenum']}{if $ds['cn'] neq ''}{$ds['cn']}{else}{$ds['id']}{/if}</a> </td>
                                ...
                                <td>{if $ds['transporte_id'] neq 0} 
                                <a href="{$_url}transportes/view/{$ds['transporte_id']}/"> Ver transporte <i class="fa fa-truck"></i></a>
                                {/if}</td>
                               ...
                               {* <td>
                                ...
                                <td>
                                <a href="{$_url}invoices/view/{$ds['pedido_id']}/">{$ds['pedido_id']}</a>
                                </td>
                                <td class="text-right">

                                    <a href="{$_url}remitos/view/{$ds['id']}/" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="{$_L['View']}"><i class="fa fa-file-text-o"></i></a>
                                    <a href="{$_url}remitos/clone/{$ds['id']}/" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="top" title="{$_L['Clone']}"><i class="fa fa-files-o"></i></a>
                                    <a href="{$_url}remitos/edit/{$ds['id']}/" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="{$_L['Edit']}"><i class="fa fa-pencil"></i></a>
