<a href="{$_url}recibos/add/1/{$cid}/" class="btn btn-primary waves-effect waves-light"><i class="fa fa-plus"></i> {$_L['New Recibo']}</a>
...
<table class="table table-bordered table-hover sys_table">
    ...
    {foreach $i as $is}
        <tr>
            ...
            <td>
                <a href="{$_url}recibos/view/{$is['id']}/" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> {$_L['View']}</a>
                <a href="{$_url}recibos/edit/{$is['id']}/" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> {$_L['Edit']}</a>
            </td>
        </tr>
    {/foreach}
