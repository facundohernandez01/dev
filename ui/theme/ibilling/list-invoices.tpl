            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        {/if}
                        <a href="{$_url}invoices/add/" class="btn btn-primary btn"><i class="fa fa-plus"></i> {$_L['Add Invoice']}</a>
                    ...
                    <table class="table table-bordered table-hover sys_table footable" {if $view_type == 'filter'} data-filter="#foo_filter" data-page-size="50" {/if}>
                        ...
                        {foreach $d as $ds}
                            <tr>
                                ...
                                <td>
                                <span class="help-block"><a href="{$_url}contacts/view/{$ds['userid']}/">{$ds['account']}</a>                             
                                </span>
                                </td>
                                ...
                                *}
                                ...
                                {elseif $ds['remito'] eq '1'}
                                <span class="label label-success">  </span> 
                                {elseif $ds['remito'] eq '3'}
                                ...
                                <td>
                                      {if $ds['recibo'] eq '0'}
                                <span class="label label-gris"> -</span> 
                                {elseif $ds['recibo'] eq '1'}
                                <span class="label label-success">  </span> 
                                {elseif $ds['recibo'] eq '3'}
                                <span class="label label">  </span> 
