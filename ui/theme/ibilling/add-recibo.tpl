                    ...
                    <form id="invform" method="post">
                        <div class="ibox-content">
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <label for="invoicenum"
                                                   class="col-sm-2 control-label">{$_L['Recibo Prefix']}</label>
                                        ...
                                        <div class="form-group">
                                            <label for="cn"
                                                   class="col-sm-2 control-label">{$_L['Recibo']} #</label>
                            ...
                            <div class="text-right">
                                ...
                                <button class="btn btn-primary" id="submit"><i class="fa fa-save"></i> {$_L['Save Recibo']}
                                </button>
                            </div>
