    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <label for="exampleInputEmail1">{$_L['Unique Recibo URL']}:</label>
                <input type="text" class="form-control" id="recibo_public_url" onClick="this.setSelectionRange(0, this.value.length)" value="{$_url}client/iview/{$d['id']}/token_{$d['vtoken']}">
            </div>
        </div>
        <div class="col-lg-12"  id="application_ajaxrender">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    {$_L['RECIBO']} N° {$d['invoicenum']}{if $d['cn'] neq ''}{$d['cn']}{else}{$d['id']}{/if}
                    ...
                    <div class="btn-group  pull-right" role="group" aria-label="...">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="#" id="mail_invoice_created">{$_L['Recibo Created']}</a></li>
                        ...
                        <a href="{$_url}recibos/edit/{$d['id']}" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> {$_L['Edit']}</a>
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{$_url}client/ipdfrec/{$d['id']}/token_{$d['vtoken']}/view/" target="_blank">{$_L['View PDF']}</a></li>
                                <li><a href="{$_url}client/ipdfrec/{$d['id']}/token_{$d['vtoken']}/dl/">{$_L['Download PDF']}</a></li>
                            </ul>
                        </div>
                        ...
                        <header class="clearfix">
                            <div class="row">
                                <div class="col-sm-6 mt-md">
                                    <h2 class="h2 mt-none mb-sm text-dark text-bold">{$_L['RECIBO']} N° {$d['invoicenum']}{if $d['cn'] neq ''}{$d['cn']}{else}{$d['id']}{/if}</h2>
                                        <div class="bill-to">
                                        <p class="h5 mb-xs text-dark text-semibold"><strong>{$_L['recibo To']}:</strong></p>
                                        <address>
                                            {if $a['company'] neq ''}
