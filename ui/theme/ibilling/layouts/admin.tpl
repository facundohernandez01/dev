                ...
                <nav class="navbar navbar-fixed-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    {if has_access($user->roleid,'sales')}
                        {if ($_c['invoicing'] eq '1') OR ($_c['quotes'] eq '1')}
                            {if $_c['quotes'] eq '1'}
                                <li class="hidden-xs"><a href="{$_url}quotes/list/">{$_L['Quotesnav']}</a></li>
                               {/if}
                            {if $_c['invoicing'] eq '1'}
                                <li class="hidden-xs"><a href="{$_url}invoices/list/">{$_L['Invoicesnav']}</a></li>
                                <li class="hidden-xs"><a href="{$_url}remitos/list/">Remitos</a></li>
                                <li class="hidden-xs"><a href="{$_url}recibos/list/">Recibos</a></li>
                            {/if}
                       ...
                       {* <li class="hidden-xs">
                        ...
                        <li class="dropdown navbar-user">
                            ...
                            <ul class="dropdown-menu animated fadeIn">
                                ...
                                <li class="divider"></li>
								<li><a href="{$_url}util/dbbackup/"><i class="fa fa-download"></i>BD Backup</a></li>
                                <li class="divider"></li>
