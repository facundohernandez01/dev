            ...
            <div class="ibox float-e-margins" id="ibox">
                <div class="ibox-title">
                    ...
                    <div class="btn-group  pull-right" role="group" aria-label="...">
                        ...
                        <a href="{$_url}quotes/edit/{$d['id']}/" class="btn btn-primary  btn-sm"><i class="fa fa-pencil"></i> {$_L['Edit']}</a>
                        <button type="button" class="btn  btn-primary btn-sm" id="convert_invoice"><i class="fa fa-plus"></i> {$_L['Convert to Invoice']}</button>
                        <div class="btn-group" role="group">
                            ...
                            <div class="col-sm-4 col-sm-offset-8">
                                <table class="table h5 text-dark">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left amount" >{$d['taxname']}</td>
                                    </tr>
