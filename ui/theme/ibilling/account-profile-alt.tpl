        ...
        <div class="col-md-3 ib_profile_width">
            ...
            <div class="panel panel-default" id="ibox_panel">
                ...
                <div class="panel-body list-group border-bottom m-t-n-lg">
                    ...
                    <a href="#" id="recibos" class="list-group-item"><span class="fa fa-file-text-o"></span> Recibos<span class="label label-info pull-right">{$recibos_count}</span></a>
					<a href="#" id="remitos" class="list-group-item"><span class="fa fa-file-text-o"></span> Remitos<span class="label label-info pull-right">{$remitos_count}</span></a>
