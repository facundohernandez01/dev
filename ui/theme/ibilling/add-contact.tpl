                        ...
                        <form class="form-horizontal" id="rform">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group"><label class="col-md-4 control-label" for="cid">Empresa {$_L['Company']}</label>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group"><label class="col-md-4 control-label" for="password">{$_L['Password']}</label>
                                        ...
                                        <div class="col-lg-8"><input type="password" id="password" name="password"value ="123456" class="form-control">
                                    ...
                                    <div class="form-group"><label class="col-md-4 control-label" for="cpassword">{$_L['Confirm Password']}</label>
                                        ...
                                        <div class="col-lg-8"><input type="password" id="cpassword" name="cpassword" value ="123456" class="form-control">
                                    ...
                                    <div class="form-group"><label class="col-md-4 control-label" for="send_client_signup_email">{$_L['Welcome Email']}</label>
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <input type="checkbox"  data-toggle="toggle" data-size="small" data-on="{$_L['Yes']}" data-off="{$_L['No']}" id="send_client_signup_email" name="send_client_signup_email" value="Yes">
