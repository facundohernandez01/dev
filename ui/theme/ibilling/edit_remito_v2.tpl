    ...
    <div class="row" id="ibox_form">
        ...
        <form id="invform" method="post">
            ...
            <div class="col-md-4">
                ...
                <input type="text" value="{$d['pedido_id']}" id="pedido_id" name="pedido_id"> 
                        </div>
                        <div class="form-group">
                        ...
                        {foreach $tpt as $tpts}
                                <option value="{$tpts['id']}"
                                {if $i['transporte_id'] eq ($tpts['id'])}selected{/if}>{$tpts['nombre_transporte']}</option>
                            {/foreach}
