<?php
/* Smarty version 4.2.0, created on 2022-08-05 13:21:14
  from 'C:\Users\97605619\local\htdocs\gestion\ui\theme\ibilling\invoice-view.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_62ed437a22cc55_56094379',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f1e2535fd061b6c49168de4e28119c43ed09d15b' => 
    array (
      0 => 'C:\\Users\\97605619\\local\\htdocs\\gestion\\ui\\theme\\ibilling\\invoice-view.tpl',
      1 => 1659716472,
      2 => 'file',
    ),
  ),
...
function content_62ed437a22cc55_56094379 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_30808609962ed437a177749_47984099', "content");
$_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['tpl_admin_layout']->value));
}
/* {block "content"} */
class Block_30808609962ed437a177749_47984099 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_30808609962ed437a177749_47984099',
  ),
);
...
" id="iid">
                    ...
                    <div class="btn-group  pull-right" role="group" aria-label="...">
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['_c']->value['accounting'] == '1') {?>
                                                        <div class="btn-group" role="group">
                            <button type="button" class="btn  btn-primary btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <i class="fa fa-ellipsis-v"></i> Remito
                                <span class="caret"></span>
                            </button>
                            <?php if ($_smarty_tpl->tpl_vars['d']->value['remito'] != 1) {?>
                            <ul class="dropdown-menu" role="menu">
                            <li><button type="button" class="btn  btn-danger btn-sm" id="convert_aremito"><i class="fa fa-plus"></i> <?php echo $_smarty_tpl->tpl_vars['_L']->value['Convert to remito'];?>
</button></li>
                            <?php if ($_smarty_tpl->tpl_vars['d']->value['remito'] != 3) {?>
                            <li><button type="button" class="btn  btn-danger btn-sm" id="convert_aremito_parcial"><i class="fa fa-plus"></i>Remito parcial</button></li>
                            <?php }?>
                            <?php }?>
                             </ul>
                            </div>
                                                        <div class="btn-group" role="group">
                            <button type="button" class="btn  btn-primary btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <i class="fa fa-ellipsis-v"></i> Recibo
                                <span class="caret"></span>
                            </button>
                                                        <?php if ($_smarty_tpl->tpl_vars['d']->value['recibo'] != 1) {?>

                            <ul class="dropdown-menu" role="menu">
                             <button type="button" class="btn  btn-info btn-sm" id="convert_arecibo"><i class="fa fa-plus"></i> Recibo </button>
                             <button type="button" class="btn  btn-info btn-sm" id="convert_arecibo_parcial"><i class="fa fa-plus"></i> Recibo parcial</button>
                            <?php }?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['d']->value['currency_symbol'];
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['d']->value['remito'] != '0') {?>                     
                       <h3>Historial pedido</h3>
                        <div class="table-responsive">
			                        <table class="table invoice-items">
                                <thead>
                                <tr class="text-dark">
                                    <th class="text-semibold">Item</th>
                                    <th class="text-center text-semibold">Ctd</th>
                                    <th class="text-center text-semibold">Fecha</th>
                                    <th class="text-center text-semibold">Remito</th>
                                </tr>
                                </thead>
                                <tbody>
                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['pedidos_remito_sub']->value, 'p_rsub');
$_smarty_tpl->tpl_vars['p_rsub']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['p_rsub']->value) {
$_smarty_tpl->tpl_vars['p_rsub']->do_else = false;
?>
                            <tr>
                            <td><?php echo $_smarty_tpl->tpl_vars['p_rsub']->value['description'];?>
</td>
                            <td class="text-center"><?php echo $_smarty_tpl->tpl_vars['p_rsub']->value['qty'];?>
</td> 
                            <td class="text-center"><?php echo $_smarty_tpl->tpl_vars['p_rsub']->value['duedate'];?>
</td> 
                            <td class="text-center"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
remitos/view/<?php echo $_smarty_tpl->tpl_vars['p_rsub']->value['invoiceid'];?>
">0001000<?php echo $_smarty_tpl->tpl_vars['p_rsub']->value['invoiceid'];?>
</a></td>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <?php if (($_smarty_tpl->tpl_vars['pedidos_recibos']->value != '' || $_smarty_tpl->tpl_vars['pedidos_recibos']->value != '0')) {?>
                     <table class="table table-bordered sys_table">
          
                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['pedidos_recibos']->value, 'p_rec');
$_smarty_tpl->tpl_vars['p_rec']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['p_rec']->value) {
$_smarty_tpl->tpl_vars['p_rec']->do_else = false;
?>
                            <tr>
                            <div class="alert alert-danger" role="alert">
                            Recibo: <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
recibos/view/<?php echo $_smarty_tpl->tpl_vars['p_rec']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['p_rec']->value['invoicenum'];
echo $_smarty_tpl->tpl_vars['p_rec']->value['id'];?>
</a>
                            Fecha: <?php echo date($_smarty_tpl->tpl_vars['_c']->value['df'],strtotime($_smarty_tpl->tpl_vars['p_rec']->value['date']));?>

                            Total: <?php echo $_smarty_tpl->tpl_vars['p_rec']->value['total'];?>

                            </div>
                            </tr>

                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['pedidos_recibos_sub']->value, 'p_recsub');
$_smarty_tpl->tpl_vars['p_recsub']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['p_recsub']->value) {
$_smarty_tpl->tpl_vars['p_recsub']->do_else = false;
?>
                            <tr>
                            <td>-> Item: <?php echo $_smarty_tpl->tpl_vars['p_recsub']->value['description'];?>
</td>
                            <td>Cant: <?php echo $_smarty_tpl->tpl_vars['p_recsub']->value['qty'];?>
</td>
                            <td>Importe: <?php echo $_smarty_tpl->tpl_vars['p_recsub']->value['total'];?>
</td>
                            </tr>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <input type="hidden" id="_lan_msg_confirm" value="seguro?">
