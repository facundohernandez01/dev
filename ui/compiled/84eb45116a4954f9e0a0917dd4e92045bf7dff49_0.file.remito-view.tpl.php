<?php
/* Smarty version 4.2.0, created on 2022-08-05 11:07:25
  from 'C:\Users\97605619\local\htdocs\gestion\ui\theme\ibilling\remito-view.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_62ed241d185333_48584907',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '84eb45116a4954f9e0a0917dd4e92045bf7dff49' => 
    array (
      0 => 'C:\\Users\\97605619\\local\\htdocs\\gestion\\ui\\theme\\ibilling\\remito-view.tpl',
      1 => 1654104236,
      2 => 'file',
    ),
  ),
...
function content_62ed241d185333_48584907 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_150859635462ed241d0c2947_07783586', "content");
$_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['tpl_admin_layout']->value));
}
/* {block "content"} */
class Block_150859635462ed241d0c2947_07783586 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_150859635462ed241d0c2947_07783586',
  ),
);
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <label for="exampleInputEmail1"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Unique Remito URL'];?>
:</label>
                <input type="text" class="form-control" id="remito_public_url" onClick="this.setSelectionRange(0, this.value.length)" value="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
        ...
        <div class="col-lg-12"  id="application_ajaxrender">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php echo $_smarty_tpl->tpl_vars['_L']->value['REMITO'];?>
...
" id="iid">
                    ...
                    <a href="#" class="btn btn-success btn-sm" id="mail_invoice_created"><i class="fa fa-envelope-o"></i> <?php echo $_smarty_tpl->tpl_vars['_L']->value['Send'];?>
</a>
...
remitos/edit/<?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
...
client/ipdfrem/<?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
/token_<?php echo $_smarty_tpl->tpl_vars['d']->value['vtoken'];?>
                        ...
                        <header class="clearfix">
                            <div class="row">
                                <div class="col-sm-6 mt-md">
                                    <h2 class="h2 mt-none mb-sm text-dark text-bold"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Remito'];?>
 N° <?php echo $_smarty_tpl->tpl_vars['d']->value['invoicenum'];
if ($_smarty_tpl->tpl_vars['d']->value['cn'] != '') {
echo $_smarty_tpl->tpl_vars['d']->value['cn'];
} else {
echo $_smarty_tpl->tpl_vars['d']->value['id'];
                                        ...
                                        <div class="bill-to">
                                        <p class="h5 mb-xs text-dark text-semibold"><strong>Enviado a:</strong></p>
                                        <address>
...
application/storage/system/logo.png" alt="Logo">
                        ...
                        <div class="bill-info">
                            <div class="row">
                                <div class="col-md-6">
                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['trsp']->value, 'tr');
...
?>
                                    <tr>
                                    <td><strong>Transporte: </strong> <?php echo $_smarty_tpl->tpl_vars['tr']->value['nombre_transporte'];?>
</td><br>
                                    <td><strong>Tel: </strong> <?php echo $_smarty_tpl->tpl_vars['tr']->value['telefono_transporte'];?>
</td><br>
                                    <td><strong>Dirección: </strong> <?php echo $_smarty_tpl->tpl_vars['tr']->value['direccion_transporte'];?>
</td><br>
                                    </tr>
                                 <?php
}
...
: <span class="amount" data-a-sign="<?php if ($_smarty_tpl->tpl_vars['d']->value['currency_symbol'] == '') {?> <?php echo $_smarty_tpl->tpl_vars['_c']->value['currency_code'];?>
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['d']->value['currency_symbol'];
                        ...
                        <div class="table-responsive">
                            <table class="table remito-items">
                                <thead>
