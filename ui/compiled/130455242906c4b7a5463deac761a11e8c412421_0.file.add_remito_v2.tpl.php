<?php
/* Smarty version 4.2.0, created on 2022-08-27 13:01:27
  from 'C:\Users\97605619\local\htdocs\gestion\ui\theme\ibilling\add_remito_v2.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_630a3fd7a419f3_74032474',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '130455242906c4b7a5463deac761a11e8c412421' => 
    array (
      0 => 'C:\\Users\\97605619\\local\\htdocs\\gestion\\ui\\theme\\ibilling\\add_remito_v2.tpl',
      1 => 1654384684,
      2 => 'file',
    ),
  ),
...
function content_630a3fd7a419f3_74032474 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_889522575630a3fd79fdf30_17178108', "content");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['tpl_admin_layout']->value));
}
/* {block "content"} */
class Block_889522575630a3fd79fdf30_17178108 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_889522575630a3fd79fdf30_17178108',
  ),
);
        ...
        <button type="button" class="btn btn-danger" id="item-remove"><i
                    class="fa fa-minus-circle"></i> <?php echo $_smarty_tpl->tpl_vars['_L']->value['Delete'];?>
                        ...
                        <div class="table-responsive m-t">
                            <table class="table remito-table" id="remito_items">
                                <thead>
                                <tr>
...
">
                            <button class="btn btn-primary" id="submit"><i class="fa fa-save"></i> Save Remito</button>
 ...
 :</strong></td>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <?php echo $_smarty_tpl->tpl_vars['cids']->value;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                   ...
                   <a href="#" id="contact_add">| O nuevo contacto</a>
                   <br><br>

                   <label for="trid">Transporte</label>

               <select id="trid" name="trid" class="form-control">
               <option value="">Selec Transporte...</option>
               <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['tpt']->value, 'tpts');
$_smarty_tpl->tpl_vars['tpts']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['tpts']->value) {
$_smarty_tpl->tpl_vars['tpts']->do_else = false;
?>
                       <option value="<?php echo $_smarty_tpl->tpl_vars['tpts']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['tpts']->value['nombre_transporte'];?>
</option>
                   <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="invoicenum" name="invoicenum" value="0001 000">
                            </div>

                            <div class="form-group">
                                <label for="cn"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Remito'];?>
 #</label>
