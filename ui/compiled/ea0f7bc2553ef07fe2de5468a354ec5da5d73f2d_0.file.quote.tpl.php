<?php
/* Smarty version 4.2.0, created on 2022-08-24 13:36:56
  from 'C:\Users\97605619\local\htdocs\gestion\ui\theme\ibilling\quote.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_630653a8cb9034_01405701',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ea0f7bc2553ef07fe2de5468a354ec5da5d73f2d' => 
    array (
      0 => 'C:\\Users\\97605619\\local\\htdocs\\gestion\\ui\\theme\\ibilling\\quote.tpl',
      1 => 1661359015,
      2 => 'file',
    ),
  ),
...
function content_630653a8cb9034_01405701 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1689466620630653a8c3f046_25196486', "content");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['tpl_admin_layout']->value));
}
/* {block "content"} */
class Block_1689466620630653a8c3f046_25196486 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_1689466620630653a8c3f046_25196486',
  ),
);
...
" id="iid">
                    ...
                    <div class="btn-group  pull-right" role="group" aria-label="...">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <?php if ($_smarty_tpl->tpl_vars['d']->value['stage'] != 'Pendiente de envío') {?>
                                    <li><a href="#" id="mark_draft"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Draft'];?>
</a></li>
                                <?php }?>
                                <?php if ($_smarty_tpl->tpl_vars['d']->value['stage'] != 'Enviado') {?>
                                    <li><a href="#" id="mark_delivered"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Delivered'];?>
</a></li>
                                <?php }?>
                                <?php if ($_smarty_tpl->tpl_vars['d']->value['stage'] != 'Parcial') {?>
                                    <li><a href="#" id="mark_accepted">Parcial</a></li>
                                <?php }?>              
...
/" class="btn btn-primary  btn-sm"><i class="fa fa-pencil"></i> <?php echo $_smarty_tpl->tpl_vars['_L']->value['Edit'];?>
</a>
                        <button type="button" class="btn  btn-primary btn-sm" id="convert_invoice"><i class="fa fa-plus"></i> <?php echo $_smarty_tpl->tpl_vars['_L']->value['Convert to Invoice'];?>
</button>
                        <div class="btn-group" role="group">
                ...
                <div class="ibox-content">
                    ...
                    <?php } elseif ($_smarty_tpl->tpl_vars['d']->value['stage'] == 'Accepted') {?>
                        <div id="ribbon-container">
                            <a href="javascript:void(0)" id="ribbon">Parcial</a>
...
: <?php echo $_smarty_tpl->tpl_vars['a']->value['account'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['d']->value['currency_symbol'];
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left amount" ><?php echo $_smarty_tpl->tpl_vars['d']->value['taxname'];?>
</td>
                                    </tr>
